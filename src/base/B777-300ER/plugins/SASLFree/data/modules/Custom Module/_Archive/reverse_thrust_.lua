...
volume_ratio = 1   		--  set this value to taste or to match your X-Plane engines volume setting.
...
sound_file = "../../../../../sounds/custom/engine/reverse_thrust_inn.wav"

if not isFileExists(sound_file) then

sound_file = "../../../../sounds/custom/engine/reverse_thrust_inn.wav"  -- normal location

if not isFileExists(sound_file) then

sound_file = "../../../sounds/custom/engine/reverse_thrust_inn.wav" -- aircraft folder located in aircraft directory
...
--local px = createGlobalProperty("donut/m", 1.0)
